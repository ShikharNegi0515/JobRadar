...
import { Bookmark, Clock, MapPin, Briefcase, ExternalLink, PlusCircle } from 'lucide-react';
        ...
        <div className="flex gap-2">
          ...
          {onApply && (
            <button 
              ...
              className="btn-primary px-4 py-1.5 text-xs bg-indigo-600 hover:bg-indigo-500 text-white border-none"
            >
